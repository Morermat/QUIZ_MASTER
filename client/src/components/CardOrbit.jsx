...
const CARDS_COUNT = 8;
const PREDICTIONS = [
  "Шутки шутками, смех смехом, но когда сова на скакалке попадается — это значит, что твой следующий проигрыш уже записан в книге судеб. {location} жди...",
  "Ты думаешь, что выиграл? Ха. Вселенная просто даёт тебе ложную надежду, чтобы больнее было падать.",
  ...
  "Ты проиграешь, даже не заметив. Но это не страшно — ты привык.",
  ...
  "Судьба любит иронию: ты стараешься, а результат всё равно зависит от того, проснулась ли сова в хорошем настроении.",
  "Твоя интуиция — это как случайный выбор в квизе. Иногда работает, чаще — нет. Но ты упорно называешь это стратегией.",
  "Сегодня ты выиграл. Завтра ты проиграешь. А послезавтра поймёшь, что это вообще не имело значения.",
  "Карты Таро говорят: ты слишком серьёзно относишься к предсказаниям. Но ты всё равно это читаешь.",
  "Ты думаешь, я шучу? Я никогда не шучу. Я просто говорю правду, а ты называешь это чёрным юмором. {location} жди...",
];
...
export default function CardOrbit() {
  ...
  return (
    <div className="fixed bottom-8 right-8 w-64 h-64 pointer-events-none z-40">
      <div className="relative w-full h-full">
        <div className="absolute inset-0 flex items-center justify-center animate-spin-slow" style={{ transformStyle: 'preserve-3d' }}>
